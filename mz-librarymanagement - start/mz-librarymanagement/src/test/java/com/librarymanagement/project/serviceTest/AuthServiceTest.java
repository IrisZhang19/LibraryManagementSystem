...
public class AuthServiceTest {
    ...
    public void TestSignupAdminSuccess(){
        ...
        when(roleRepository.findByRoleName(AppRole.ROLE_USER)).thenReturn(Optional.of(roleUser));        when(userRepository.save(any(User.class))).thenReturn(any(User.class));
